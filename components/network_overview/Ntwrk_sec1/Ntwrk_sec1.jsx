...
const Ntwrk_sec1 = () => {
  return (
    <div>
      <div className="relative w-full aspect-[9/15] md:aspect-auto overflow-hidden h-auto  lg:h-[70svh] xl:h-[calc(100vh-80px)]">
        <video
          autoPlay
          muted
          loop
        ...
        >
          <source
            src="/network_overview/Network_Overview_mobile.mp4"
            type="video/mp4"
          />
        </video>
