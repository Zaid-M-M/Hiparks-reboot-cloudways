...
//                 {/* Second link */}
//                 <TransitionLink
//                   href="/integrated-business-solutions" // 👈 your target URL
//                   className="flex items-center justify-between w-full gap-1.5 sm:gap-4 group"
//                 >
...
export default function HeroBannerClient() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full text-white h-[auto] md:h-[70vh] xl:h-[100vh] overflow-hidden"
    >
      {loadVideo && (
        <>
          <video
      ...
      <div className="z-10 flex flex-col items-end justify-end w-full h-full p-3 md:p-6 bg-gradient-to-r from-black/60 to-transparent">
        <div className="z-10 flex w-full items-center gap-2 md:gap-5 justify-end">
          <div className="relative w-[160px] h-[55px] md:w-[280px] md:h-[120px]">
            <MotionWrapper
              initial={isDesktop ? { y: 80, opacity: 0 } : {}}
              whileInView={isDesktop ? { y: 0, opacity: 1 } : {}}
              transition={isDesktop ? { duration: 0.8, delay: 0.2 } : {}}
              viewport={{ once: true }}
            >
              <Image
                src="/leftcon.png"
