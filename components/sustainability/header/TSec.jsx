  ...
  return (
    <div className="lg:min-h-screen min-h-[85vh] flex flex-col justify-start items-center py-[45px] lg:py-[70px] relative overflow-hidden">
      ...
      <video
        ...
        loop
        playsInline
        // src="/sustainability/sustainable_banner_desk.mp4"
        src="https://phpstack-725513-2688800.cloudwaysapps.com/cms/wp-content/uploads/2025/12/sustainable_banner_desk.mp4"
      />
      ...
      <video
        ...
        loop
        playsInline
        // src="/sustainability/sustainable_banner_mob.mp4"
        src="https://phpstack-725513-2688800.cloudwaysapps.com/cms/wp-content/uploads/2025/12/sustainable_banner_mob.mp4"
      />
