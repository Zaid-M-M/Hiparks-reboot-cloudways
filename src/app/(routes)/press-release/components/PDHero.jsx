...
//   const getImageUrl = () => {
//     if (blog?.contentType === "press_release" && blog.acf?.pr_spotlight_image)
//       return blog.acf.pr_spotlight_image;
//   };
...
//             items={[
//               { label: "Home", href: "/" },
//               { label: "Press Release", href: "/insights" },
//             ]}
//             color="#000000"
//           />
//         </div>
...
//             alt={blog?.title?.rendered || "Press Release Image"}
//             width={1920}
//             height={1080}
//             sizes="100vw"
...
const PDHero = ({ pressRelease }) => {
  ...
  const spotlightImage = pressRelease.acf?.pr_spotlight_image;
  const title =
    pressRelease.title?.rendered || pressRelease.title || "Untitled";
    ...
    <div className="w-full pt-[45px] pb-0 bg-white">
      <div className="fix">
        ...
        {spotlightImage ? (
          <div className="w-full overflow-hidden">
            <Image
              src={formatMediaUrl(spotlightImage)}
              priority
              unoptimized
              alt={title}
              width={1920}
          ...
          <div className="mb-[45px] md:mb-[125px]" />
        )}
      </div>
    </div>
  );
